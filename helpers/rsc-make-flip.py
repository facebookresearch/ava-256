...
for e in exps:
    ...
    for cam in cams:
        ...
        for no in range(0, 1000, 10):
            ...
            g = img[:, w*2:w*3, :]
            g = cv2.putText(g, f"GT-c{cam}", (20, 60), cv2.FONT_HERSHEY_SIMPLEX, 0.8, (255, 255, 255), 1)
            r = img[:, w:w*2, :]
            r = cv2.putText(r, f"RECON-abf{abf}-f{fr}-c{cam}", (20, 60), cv2.FONT_HERSHEY_SIMPLEX, 0.8, (255, 255, 255), 1)

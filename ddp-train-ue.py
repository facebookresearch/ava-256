...
def prepare(rank, world_size, train_params):
    ...
    train_dataset = HeadsetMultiCaptureDataset(train_captures, train_dirs, train_gt_dirs, downsample=2.083)
    ...
    valid_dataset = HeadsetMultiCaptureDataset(valid_captures, valid_dirs, valid_gt_dirs, downsample=2.083)

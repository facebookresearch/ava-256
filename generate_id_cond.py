...
from data.ava_dataset import (
    MultiCaptureDataset as AvaMultiCaptureDataset,
    none_collate_fn,
    SingleCaptureDataset as AvaSingleCaptureDataset,
)
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--output-dir", type=str, default="identity_conditioning/", help="output directory"
    )
    parser.add_argument(

...
parser.add_argument('-i', '--input', default='selectedIMGFiles_compressed/', help='output folder to store compressed files')

args = parser.parse_args()


variables = [('ssim', 'SSIM'), ('psnr', 'PSNR'), ('time-compress', 'Compression Time'), ('time-decompress', 'Decompression Time')]
